...
Compared with all of these, economics is well placed, because the relations
among a model's objects are the theory itself — stated in the paper, but not
systematically attached to the files and function calls that compute it.
...
doi:10.1016/j.jebo.2012.01.006
